...
if(
userDetails.accountNumber===account.accountNumber && isValidPin(userDetails.pin)
)
{
...
async function withdraw():Promise<void> {
  let withdrawDetails:Answers=await inquirer.prompt([{
    name:"amount",
    type:"number",
  ...
  console.log(
    `withdraw Amount:${amount} Remianing Balance:${account.balance}`
  );
  performAction();
}
